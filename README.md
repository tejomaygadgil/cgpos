...
This morphological approach addresses the major difficulty of parsing Ancient Greek: namely, the [complex system of word endings](https://en.wiktionary.org/wiki/Appendix:Ancient_Greek_grammar_tables) used to indicate part-of-speech[^1] that results in free word order[^2] and many [singularly occurring](https://en.wikipedia.org/wiki/Hapax_legomenon#Ancient_Greek_examples) words.
