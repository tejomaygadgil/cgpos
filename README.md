...
# Model
Ancient Greek is difficult to parse due to its use of [word endings](https://en.wiktionary.org/wiki/Appendix:Ancient_Greek_grammar_tables)[^1] instead of word order to indicate part-of-speech. Greek words therefore possess more grammatical information than English words[^2].

This means we cannot necessarily rely on [classical methods](https://en.wikipedia.org/wiki/Hidden_Markov_model) for  part-of-speech tagging due to their reliance on use word order to make predictions.
