...
Fine-frained part-ofspeech predictions are generated by following the simple [multioutput strategy](https://scikit-learn.org/stable/modules/generated/sklearn.multioutput.MultiOutputClassifier.html) of fitting one `MultinomialNaiiveBayes` per target.
`StupidBayes`[^3]
